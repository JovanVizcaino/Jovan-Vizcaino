...
class List(object):   
    ...
    #Solution 1
    #Method that compares elements of a list with the next word and determines if they are duplicates. At the end it will return the number of duplicates found in the list.
