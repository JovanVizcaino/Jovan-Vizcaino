...
def main(): 
    print("Select the .txt file you want to implement:")
    file = input() 
    print("") 
    print("Want to use an AVL tree or a Black-Red tree or a B-Tree? Select from below:") 
    print("A. AVL Tree")
